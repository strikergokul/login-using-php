...
session_start();
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
    ...
    if(!empty($regno) && !empty($password) )
    {
      ...
      //read from database
      $query = "select * from userstudent where regno = '$regno' limit 1";
        ...
        <section class="col-12 col-sm-6 col-md-3">
          <form class="formbox" method="post">
            ...
            <div class="mb-3">
              ...
              <input type="Number" name="regno" class="form-control" id="registernumber" aria-describedby="emailHelp">
            </div>
            <div class="mb-3">
            ...
            <div style="display: inline;">
              ...
              <a id="signupbutton" style="color: black;" href="studentsignup.php">Signup</a>
            </div>
          </form>
        </section>
      </section>
